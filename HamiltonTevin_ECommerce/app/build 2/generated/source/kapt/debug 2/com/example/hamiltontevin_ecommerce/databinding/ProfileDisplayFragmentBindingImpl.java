...
public class ProfileDisplayFragmentBindingImpl extends ProfileDisplayFragmentBinding implements com.example.hamiltontevin_ecommerce.generated.callback.OnClickListener.Listener {
    ...
    private androidx.databinding.InverseBindingListener etEAddressandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.emailLiveData.getValue()
            //         is viewModel.emailLiveData.setValue((java.lang.String) callbackArg_0)
            java.lang.String callbackArg_0 = androidx.databinding.adapters.TextViewBindingAdapter.getTextString(etEAddress);
    ...
    private androidx.databinding.InverseBindingListener etFullNameandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.fullNameLiveData.getValue()
            //         is viewModel.fullNameLiveData.setValue((java.lang.String) callbackArg_0)
            java.lang.String callbackArg_0 = androidx.databinding.adapters.TextViewBindingAdapter.getTextString(etFullName);
            // localize variables for thread safety
            // viewModel.fullNameLiveData
            androidx.lifecycle.MutableLiveData<java.lang.String> viewModelFullNameLiveData = null;
            // viewModel.fullNameLiveData != null
            boolean viewModelFullNameLiveDataJavaLangObjectNull = false;
            // viewModel.fullNameLiveData.getValue()
            ...
            if (viewModelJavaLangObjectNull) {
                ...
                viewModelFullNameLiveDataJavaLangObjectNull = (viewModelFullNameLiveData) != (null);
                if (viewModelFullNameLiveDataJavaLangObjectNull) {




                    viewModelFullNameLiveData.setValue(((java.lang.String) (callbackArg_0)));
                }
            }
        }
    };
    private androidx.databinding.InverseBindingListener etPNumberandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.phoneNumLiveData.getValue()
            //         is viewModel.phoneNumLiveData.setValue((java.lang.String) callbackArg_0)
            java.lang.String callbackArg_0 = androidx.databinding.adapters.TextViewBindingAdapter.getTextString(etPNumber);
            // localize variables for thread safety
            // viewModel.phoneNumLiveData != null
            boolean viewModelPhoneNumLiveDataJavaLangObjectNull = false;
            // viewModel.phoneNumLiveData
            androidx.lifecycle.MutableLiveData<java.lang.String> viewModelPhoneNumLiveData = null;
            // viewModel
            com.example.hamiltontevin_ecommerce.viewModel.FragmentsViewModel viewModel = mViewModel;
            // viewModel != null
            boolean viewModelJavaLangObjectNull = false;
            // viewModel.phoneNumLiveData.getValue()
            ...
            if (viewModelJavaLangObjectNull) {
                ...
                viewModelPhoneNumLiveDataJavaLangObjectNull = (viewModelPhoneNumLiveData) != (null);
                if (viewModelPhoneNumLiveDataJavaLangObjectNull) {




                    viewModelPhoneNumLiveData.setValue(((java.lang.String) (callbackArg_0)));
                }
            }
        }
    };
    private androidx.databinding.InverseBindingListener tvUserEAddressandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.emailLiveData.getValue()
            //         is viewModel.emailLiveData.setValue((java.lang.String) callbackArg_0)
            java.lang.String callbackArg_0 = androidx.databinding.adapters.TextViewBindingAdapter.getTextString(tvUserEAddress);
            // localize variables for thread safety
            // viewModel.emailLiveData != null
            boolean viewModelEmailLiveDataJavaLangObjectNull = false;
            // viewModel.emailLiveData
    ...
    private androidx.databinding.InverseBindingListener tvUserPNumberandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of viewModel.phoneNumLiveData.getValue()
            //         is viewModel.phoneNumLiveData.setValue((java.lang.String) callbackArg_0)
            java.lang.String callbackArg_0 = androidx.databinding.adapters.TextViewBindingAdapter.getTextString(tvUserPNumber);
            // localize variables for thread safety
            // viewModel.phoneNumLiveData != null
            boolean viewModelPhoneNumLiveDataJavaLangObjectNull = false;
            // viewModel.phoneNumLiveData
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.etEAddress, (androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged)null, etEAddressandroidTextAttrChanged);
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.etPNumber, (androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged)null, etPNumberandroidTextAttrChanged);
            androidx.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.tvUserEAddress, (androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged)null, tvUserEAddressandroidTextAttrChanged);
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.tvUserPNumber, (androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged)null, tvUserPNumberandroidTextAttrChanged);
        }
        if ((dirtyFlags & 0x64L) != 0) {
            // api target 1
